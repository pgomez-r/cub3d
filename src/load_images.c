...
/*   Updated: 2024/06/30 23:12:22 by pgruz11          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_create_minipmap(t_data *d)
{
	...
	d->maps.map_scale_x = (float)(d->imgs.mini_src->width / d->maps.pix_width);
	d->maps.map_scale_y = (float)(d->imgs.mini_src->height / d->maps.pix_height);
